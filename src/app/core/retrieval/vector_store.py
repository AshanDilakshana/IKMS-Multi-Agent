...
def index_documents(file_path: Path) -> int:
    ...
    """
    #pymupdfloader = heding starcture maintain and pdf in side images we can defin multilevel llm like gpt 4o-mini if after send image to llm and captinon and put on image section
